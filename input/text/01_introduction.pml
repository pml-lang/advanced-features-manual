[ch [title Introduction]
    ...
    Advanced features aim to simplify and automate the writing process as far as possible. As a result they can significantly increase productivity, maintainability, and reliability, especially in professional environments where documents change often, content depends on external resources, or parts of the document should be created automatically.
    ...
    [list
        ...
        [el embed Javascript source code snippets in a PML document, to dynamically generate PML code and resources (e.g. graphical components like diagrams) at build-time, and to execute external OS commands and scripts that can create content or do anything else related to the PML document]
