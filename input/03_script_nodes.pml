[ch (id=script_nodes) [title Script Nodes (Experimental)]
    ...
    [list
        [el
            ...
            Example: Update the [i last updated] field each time a document is re-generated.
        ]
        ...
        [el
            ...
            Example: Use [link url=https://plantuml.com/ text=PlantUML] to create a MindMap diagram, and insert a link to it in the document.
        ]
    ...
    [i Script Nodes] is a feature of the [link url=https://pdml-lang.github.io/ text="Practical Data and Markup Language (PDML)"].
